...
Canonical invocation (works from any CWD inside the container):

    python -m trading_bot.admin.billing_verification
    trading-bot-billing-verify --strict

Back-compat invocation (kept so older runbooks still work):
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="trading-bot-billing-verify",
