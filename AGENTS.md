...
Governance: `ehudso7/project-governance` v2.4.0 · profile `regulated-system` · criticality `critical`
...
- `malik validate` — validate this repository against profile `regulated-system`
